...
const DAY_LINKS={
  fusion:[['Day 1','day1.html#fusion']],
  'pho-sol':[['Day 1','day1.html#pho-sol']],
  'post-office':[['Day 1','day1.html#post-office']],
  'notre-dame':[['Day 1','day1.html#post-office']],
  'book-street':[['Day 1','day1.html#post-office']],
  'nha-suga':[['Day 1','day1.html#nha-suga']],
  'omakase-tiger':[['Day 1','day1.html#omakase-tiger']],
  'cafe-apartments':[['Day 1','day1.html#cafe-apartments']],
  'com-tam-moc':[['Day 2','day2.html#com-tam-moc']],
  cooking:[['Day 2','day2.html#cooking']],
  libe:[['Day 2','day2.html#libe']],
  dauple:[['Day 2','day2.html#dauple']],
  nosbyn:[['Day 2','day2.html#nosbyn']],
  'new-playground':[['Day 2','day2.html#new-playground']],
  'moc-kim':[['Day 2','day2.html#moc-kim']],
  lune:[['Day 2','day2.html#lune']],
  'quan-thuy':[['Day 3','day3.html#quan-thuy']],
  'pink-church':[['Day 3','day3.html#pink-church']],
  cong:[['Day 3','day3.html#pink-church']],
  'push-push':[['Day 3','day3.html#push-push'],['Day 4','day4.html#push-push']],
  'saigon-concept':[['Day 3','day3.html#saigon-concept']],
  bakes:[['Day 3','day3.html#bakes']],
  ohquao:[['Day 3','day3.html#ohquao']],
  'moc-huong':[['Day 3','day3.html#moc-huong']],
  'little-bear':[['Day 3','day3.html#little-bear']],
  marou:[['Day 3','day3.html#marou']],
  'running-bean':[['Day 4','day4.html#running-bean']],
  'war-museum':[['Day 4','day4.html#war-museum']],
  pizza4ps:[['Day 4','day4.html#pizza4ps']],
  garmentory:[['Day 4','day4.html#garmentory']],
  'temple-leaf':[['Day 4','day4.html#temple-leaf']],
  quince:[['Day 4','day4.html#quince']],
  'pho-vietnam':[['Day 5','day5.html#pho-vietnam']],
  'fine-arts':[['Day 5','day5.html#fine-arts']],
  'bep-me-in':[['Day 5','day5.html#bep-me-in']],
  'ha-spa':[['Day 5','day5.html#ha-spa']]
};
...
function quickInfoHTML(g,key){
 return `<div class="quick-info-card"><div class="quick-info-top"><span class="category-tag">${g.categoryLabel||g.cat||'Guide'}</span></div><div class="quick-info-grid"><div class="quick-info-row"><span class="quick-info-icon">📍</span><span><span class="quick-info-label">Address</span><span class="quick-info-value">${g.address||'Check before visit'}</span></span></div><div class="quick-info-row"><span class="quick-info-icon">🕘</span><span><span class="quick-info-label">Hours</span><span class="quick-info-value">${g.hours||'Check before visit'}</span></span></div><div class="quick-info-row"><span class="quick-info-icon">💰</span><span><span class="quick-info-label">Price</span><span class="quick-info-value">${g.price||'Varies'}</span></span></div>${visitDayHTML(key)}</div><div class="quick-info-actions"><a class="map-button" href="${g.maps}" target="_blank" rel="noopener">🗺 Open Google Maps</a><button class="moment-button" aria-label="Add Moment" onclick="openMomentsModal('${key}')">✨</button></div></div>`;
}
