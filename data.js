...
const DAY_LINKS={
  ...
  'sushi-koji':[['Day 1','day.html?day=1#sushi-koji']],
...
const GUIDE_ORDER=["fusion", "bakes", "cong", "marou", "cafe-apartments", "running-bean", "bep-me-in", "com-tam-moc", "little-bear", "lune", "sushi-koji", "pho-sol", "pho-vietnam", "pizza4ps", "quince", "quan-thuy", "garmentory", "dauple", "libe", "nosbyn", "ohquao", "push-push", "saigon-concept", "new-playground", "ha-spa", "moc-huong", "moc-kim", "nha-suga", "tinh-thuc", "fine-arts", "book-street", "notre-dame", "post-office", "pink-church", "war-museum", "cooking"];
...
const BOOKINGS_DATA = {
  ...
  "sushi-koji-booking": {
    id: "sushi-koji-booking",
    type: "restaurant",
    title: "Sushi Koji — Dinner",
    status: "toBook",
    date: "2026-10-30",
    time: "18:00",
    placeId: "sushi-koji",
    ...
    guests: 4,
    reference: null,
    contact: "+84 906 279 360",
    address: "18A Ngô Văn Năm, Bến Nghé, District 1, Ho Chi Minh City, Vietnam",
    mapUrl: "https://maps.google.com/?q=Sushi+Koji+18A+Ngo+Van+Nam+District+1",
    paymentStatus: "unpaid",
    notes: "18:00，4 位；建議以官方 hotline 提前確認 omakase menu 及訂位。",
    reminders: [],
...
const ITINERARY_SCHEMA_EXAMPLES = {
  meal: {
    id: "example-meal-sushi-koji",
    type: "meal",
    dayId: "day1",
    time: "17:30",
    title: "Sushi Koji — Dinner",
    placeId: "sushi-koji",
    bookingId: "sushi-koji-booking",
    notes: "日落場，8 座板前。"
  },
  transport: {
  ...
  note: {
    ...
    placeId: null,
    bookingId: null,
    notes: "例如：出發前落實 Sushi Koji 營業狀態。"
  }
};
...
/* ============================================================================
   ...
   ITINERARY_SCHEMA_EXAMPLES vocabulary defined above:
     ...
     bookingId links to BOOKINGS_DATA where a real booking exists for that
               placeId (currently: sushi-koji -> sushi-koji-booking,
